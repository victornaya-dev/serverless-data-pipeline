    ...
    widgets = [
      ...
      # -------------------------------------------------------
      {
        ...
        properties = {
          ...
          region  = "us-east-1"
          metrics = [
            ["AWS/States", "ExecutionsStarted",   "StateMachineArn", "arn:aws:states:us-east-1:329177708113:stateMachine:StepFunction_MultipleMeteo", { stat = "Sum", label = "Started" }],
            ["AWS/States", "ExecutionsSucceeded", "StateMachineArn", "arn:aws:states:us-east-1:329177708113:stateMachine:StepFunction_MultipleMeteo", { stat = "Sum", color = "#2ca02c", label = "Succeeded" }],
            ["AWS/States", "ExecutionsFailed",    "StateMachineArn", "arn:aws:states:us-east-1:329177708113:stateMachine:StepFunction_MultipleMeteo", { stat = "Sum", color = "#d62728", label = "Failed" }]
          ]
          period = 300
        }
      },
      {
        ...
        properties = {
          ...
          region  = "us-east-1"
          metrics = [
            ["AWS/States", "ExecutionTime", "StateMachineArn", "arn:aws:states:us-east-1:329177708113:stateMachine:StepFunction_MultipleMeteo", { stat = "Average", label = "Avg" }],
            ["AWS/States", "ExecutionTime", "StateMachineArn", "arn:aws:states:us-east-1:329177708113:stateMachine:StepFunction_MultipleMeteo", { stat = "Maximum", label = "Max" }]
          ]
          period = 300
        }
      },
      {
        ...
        properties = {
          ...
          region  = "us-east-1"
          metrics = [
            ["AWS/States", "ExecutionThrottled", "StateMachineArn", "arn:aws:states:us-east-1:329177708113:stateMachine:StepFunction_MultipleMeteo", { stat = "Sum", color = "#ff9900", label = "Throttled" }],
            ["AWS/States", "ExecutionsAborted",  "StateMachineArn", "arn:aws:states:us-east-1:329177708113:stateMachine:StepFunction_MultipleMeteo", { stat = "Sum", color = "#9467bd", label = "Aborted" }]
          ]
          period = 300
        }
      },
